...
import { Ship, Users, Calendar, Award } from "lucide-react";
        ...
        {culturalFacts.map((fact, index) => (
          <motion.div
            ...
            className={`text-center p-8 rounded-3xl ${
              isDarkMode
                ? "bg-emerald-800"
                : "bg-gradient-to-br from-white to-stone-100"
          ...
          >
            ...
            <p className={`${isDarkMode ? "text-stone-300" : "text-gray-600"} leading-relaxed`}>
              {fact.description}
            </p>
          </motion.div>
        ))}
