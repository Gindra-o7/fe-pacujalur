    ...
    <div className="max-w-7xl mx-auto px-6">
      ...
      <div className="mb-16 relative">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className={`absolute bottom-20 right-16 w-24 h-24 rounded-full opacity-10 ${
            isDarkMode ? "bg-teal-400" : "bg-teal-600"
          }`} />
          <div className={`absolute top-1/2 right-1/4 w-16 h-16 rounded-full opacity-10 ${
        ...
        >
          <div className="gallery-wrapper relative">
            <div className={`absolute -top-4 -left-4 w-full h-full border-2 border-dashed rounded-2xl opacity-30 ${
            ...
            <div className="relative p-6 rounded-2xl backdrop-blur-sm bg-opacity-50 border border-opacity-20 shadow-xl">
              <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br opacity-5 ${
                isDarkMode 
                  ...
                  : "from-emerald-100 via-teal-100 to-emerald-200"
              }`} />
        ...
        <motion.div
          className={`absolute -top-8 -right-8 w-20 h-20 rounded-xl shadow-lg hidden md:block ${
            isDarkMode ? "bg-gradient-to-br from-emerald-600 to-teal-700" : "bg-gradient-to-br from-emerald-200 to-teal-300"
          }`}
          animate={{ 
            y: [0, -10, 0],
            rotate: [0, 5, 0]
        ...
        <motion.div
          className={`absolute -bottom-6 -left-6 w-16 h-16 rounded-full shadow-lg hidden lg:block ${
            isDarkMode ? "bg-gradient-to-br from-teal-600 to-emerald-700" : "bg-gradient-to-br from-teal-200 to-emerald-300"
          }`}
          animate={{ 
            y: [0, 8, 0],
            x: [0, 5, 0]
