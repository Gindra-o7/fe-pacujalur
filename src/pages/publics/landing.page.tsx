...
// import penginapan4 from "@/assets/penginapan-4.webp";
// import penginapan5 from "@/assets/penginapan-5.webp";
...
const PacuJalurTourism = () => {
  ...
  const events = [
    {
      ...
      subtitle: "Tepian Nyiur Melambai, Cerenti",
    ...
    },
    {
      ...
      subtitle: "Tepian Gunung Pulau Gubah, Hulu Kuantan",
    ...
    },
    {
      ...
      subtitle: "Tepian Datoak Bandaro Lelo Budi, Desa Kari",
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment: "Pengalaman yang luar biasa! Pacu Jalur bukan hanya sekedar perlombaan, tapi juga pembelajaran budaya yang mendalam.",
      event: "Pacu Jalur Rayon 1"
    },
    {
      id: 2,
      name: "Siti Nurhaliza",
      ...
      rating: 5,
      comment: "Pemandangannya spektakuler! Moment-moment yang diabadikan di sini akan menjadi kenangan selamanya.",
      event: "Pacu Jalur Rayon 2"
    },
    {
      id: 3,
      name: "Budi Santoso",
      ...
      rating: 5,
      comment: "Organisasi acara yang sangat baik, fasilitas lengkap, dan hospitality yang luar biasa dari masyarakat lokal.",
      event: "Pacu Jalur Rayon 3"
    }
  ];
  ...
  const BookingModal = () => (
    <AnimatePresence>
      {showBookingModal && selectedEvent && (
        ...
        >
          <motion.div
            className="bg-white rounded-3xl p-8 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto"
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-xl font-bold mb-4 text-gray-800">Detail Event</h3>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-2xl text-blue-600">{selectedEvent.price}</span>
                  </div>
                </div>

                <h4 className="text-lg font-bold mt-6 mb-3">Fitur Termasuk:</h4>
              ...
              <div>
                <h3 className="text-xl font-bold mb-4 text-gray-800">Jadwal Kegiatan</h3>
                <div className="space-y-3">
                  {selectedEvent.schedule.map((item, index) => (
                    <div key={index} className="flex gap-3">
                      <div className="bg-blue-600 text-white px-2 py-1 rounded text-sm font-medium min-w-[60px] text-center">
                        {item.time}
                      </div>
            ...
            <div className="mt-8 flex gap-4">
              ...
              >
                Book Sekarang - {selectedEvent.price}
              </button>
              <button 
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-gradient-to-br from-blue-50 via-white to-cyan-50'} transition-colors duration-300`}>
      ...
      <nav className={`fixed top-0 w-full z-50 ${isDarkMode ? 'bg-gray-900/80' : 'bg-white/80'} backdrop-blur-lg border-b ${isDarkMode ? 'border-gray-700' : 'border-white/20'} transition-colors duration-300`}>
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Desktop Menu - SUDAH DIPERBARUI */}
            <div className="hidden md:flex items-center space-x-8">
              <Link to="home" smooth={true} duration={500} offset={-100} className={`${isDarkMode ? 'text-gray-300 hover:text-blue-400' : 'text-gray-700 hover:text-blue-600'} transition-colors cursor-pointer`}>Beranda</Link>
              <Link to="events" smooth={true} duration={500} offset={-80} className={`${isDarkMode ? 'text-gray-300 hover:text-blue-400' : 'text-gray-700 hover:text-blue-600'} transition-colors cursor-pointer`}>Jadwal</Link>
              <Link to="gallery" smooth={true} duration={500} offset={-80} className={`${isDarkMode ? 'text-gray-300 hover:text-blue-400' : 'text-gray-700 hover:text-blue-600'} transition-colors cursor-pointer`}>Galeri</Link>
              <Link to="testimonials" smooth={true} duration={500} offset={-80} className={`${isDarkMode ? 'text-gray-300 hover:text-blue-400' : 'text-gray-700 hover:text-blue-600'} transition-colors cursor-pointer`}>Testimoni</Link>
              <Link to="contact" smooth={true} duration={500} offset={-80} className={`${isDarkMode ? 'text-gray-300 hover:text-blue-400' : 'text-gray-700 hover:text-blue-600'} transition-colors cursor-pointer`}>Kontak</Link>
              
              <button
                onClick={() => setIsDarkMode(!isDarkMode)}
                className={`p-2 rounded-full ${isDarkMode ? 'bg-gray-800 text-yellow-400' : 'bg-gray-100 text-gray-600'} hover:scale-110 transition-all`}
              >
                {isDarkMode ? <Sun className="w-5 h-5" /> : <Moon className="w-5 h-5" />}
              </button>
              
              <button className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-6 py-2 rounded-full hover:shadow-lg transition-all">
                Beli Tiket
              </button>
            </div>
          ...
          {isMenuOpen && (
            ...
            >
              <div className="px-6 py-4 space-y-4">
                <Link to="home" smooth={true} duration={500} offset={-100} onClick={() => setIsMenuOpen(false)} className={`block ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} cursor-pointer`}>Beranda</Link>
                <Link to="events" smooth={true} duration={500} offset={-80} onClick={() => setIsMenuOpen(false)} className={`block ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} cursor-pointer`}>Jadwal</Link>
                <Link to="gallery" smooth={true} duration={500} offset={-80} onClick={() => setIsMenuOpen(false)} className={`block ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} cursor-pointer`}>Galeri</Link>
                <Link to="testimonials" smooth={true} duration={500} offset={-80} onClick={() => setIsMenuOpen(false)} className={`block ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} cursor-pointer`}>Testimoni</Link>
                <Link to="contact" smooth={true} duration={500} offset={-80} onClick={() => setIsMenuOpen(false)} className={`block ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} cursor-pointer`}>Kontak</Link>
                <button className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-2 rounded-full">
                  Beli Tiket
                </button>
              </div>
            </motion.div>
      ...
      <section className={`py-20 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
        <div className="max-w-7xl mx-auto px-6">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className={`text-4xl md:text-5xl font-bold mb-6 ${isDarkMode ? 'text-white' : 'bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent'}`}>
              Fakta Budaya
            </h2>
      ...
      <section id="events" className={`py-20 ${isDarkMode ? 'bg-gray-900' : 'bg-gradient-to-br from-gray-50 to-blue-50'}`}>
        <div className="max-w-7xl mx-auto px-6">
            ...
            <AnimatePresence>
              {filteredEvents.map((event, index) => (
                <motion.div
                  ...
                  className={`group ${isDarkMode ? 'bg-gray-800' : 'bg-gradient-to-br from-white to-gray-50'} rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden ${isDarkMode ? 'border border-gray-700' : 'border border-gray-100'}`}
                  transition={{ delay: index * 0.1 }}
                  whileHover={{ y: -5 }}
                >
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4">
                      <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                        ...
                        event.difficulty === 'Intermediate' ? 'bg-yellow-500 text-white' :
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      ...
                      {event.features.length > 3 && (
                        <span className="text-blue-600 text-xs px-2 py-1">
                          +{event.features.length - 3} lainnya
                        </span>
                      )}
                    </div>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <button className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-8 py-4 rounded-full font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105">
            ...
            {accommodations.map((hotel, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className={`text-lg mb-8 leading-relaxed ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                Kenal jalur-jalur legendaris yang menjadi kebanggaan desa-desa di Kuantan Singingi. 
                Setiap jalur memiliki nama unik, cerita, serta semangat masyarakat yang mendayungnya.
              </p>
      ...
      <section id="testimonials" className={`py-20 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className={`text-xl max-w-3xl mx-auto ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              Dengarkan cerita inspiratif dari para wisatawan yang telah merasakan keajaiban Pacu Jalur
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <motion.div
                key={testimonial.id}
                className={`p-8 rounded-3xl ${isDarkMode ? 'bg-gray-700' : 'bg-gradient-to-br from-blue-50 to-cyan-50'} hover:shadow-xl transition-all duration-500`}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
      ...
      {/* Contact Section */}
      <section id="contact" className={`py-20 ${isDarkMode ? 'bg-gray-900' : 'bg-gradient-to-br from-blue-600 via-cyan-600 to-teal-600'}`}>
        <div className="max-w-7xl mx-auto px-6">
          <motion.div 
            className="text-center mb-16"
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-white/90">
              Siap untuk petualangan tak terlupakan? Tim kami siap membantu merencanakan kunjungan Anda
            </p>
          </motion.div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="text-white/70 text-sm">Telepon</div>
                      <div className="text-white font-semibold">+62 813-7654-3210</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white font-semibold">info@pacujalur-kuansing.com</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="text-white/70 text-sm">Alamat</div>
                      <div className="text-white font-semibold">Teluk Kuantan, Kuantan Singingi, Riau</div>
                    </div>
                  </div>
                </div>
                ...
                <form className="space-y-6">
                  <div>
                    <input
                      ...
                      className="w-full bg-white/20 border border-white/30 rounded-xl px-4 py-3 text-white placeholder-white/70 focus:border-white/50 focus:outline-none transition-colors"
                    />
                  </div>
                  <div>
                    <input
                  ...
                  <div>
                    <textarea
                      ...
                      className="w-full bg-white/20 border border-white/30 rounded-xl px-4 py-3 text-white placeholder-white/70 focus:border-white/50 focus:outline-none transition-colors resize-none"
                    ></textarea>
                  </div>
                  <button
                    type="submit"
                    className="w-full bg-white text-blue-600 py-4 rounded-xl font-bold hover:bg-gray-100 transition-colors"
                  >
                    Kirim Pesan
                  </button>
                </form>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li><a href="#events" className="hover:text-blue-400 transition-colors">Jadwal Event</a></li>
                <li><a href="#packages" className="hover:text-blue-400 transition-colors">Paket Wisata</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li><a href="#" className="hover:text-blue-400 transition-colors">Pacu Jalur Rayon 1</a></li>
                <li><a href="#" className="hover:text-blue-400 transition-colors">Pacu Jalur Rayon 2</a></li>
                <li><a href="#" className="hover:text-blue-400 transition-colors">Pacu Jalur Rayon 3</a></li>
                <li><a href="#" className="hover:text-blue-400 transition-colors">Pacu Jalur Rayon 4</a></li>
                <li><a href="#" className="hover:text-blue-400 transition-colors">Festival Budaya</a></li>
                <li><a href="#" className="hover:text-blue-400 transition-colors">Workshop Tradisional</a></li>
              </ul>
            </div>
